...
![diagram that shows STS and disability studies together with an arrow towards the text "data visualization"](/img/1-zoom-access-ineq.png){:height="30%" width="30%"}
...
![tweet from Liz Jackson that says "The remnants of a Zoom bombing of a disability event" with a black square](/img/2-liz-jackson-bomb.png){:height="50%" width="50%"}
...
![a vinyl map of MIT where there are raised etchings for different components of the campus](/img/4-mit-tactual.png){:height="50%" width="50%"}
...
![page from a handbook that shows sketches of different tools made for embossing tactile graphics: scalpels, pen-like utensils to punch bumps in the paper](/img/5-tactile-tools.png){:height="50%" width="50%"}
...
![a close-up view of the tactual map of MIT, where you can see the individual dots and lines that make up a building](/img/6-mit-tactual-detail.png){:height="50%" width="50%"}
