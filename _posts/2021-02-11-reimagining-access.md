...
**(Slide 24)** How can we reduce visual or tactile clutter and use texture and shapes judiciously? My collaborator, [Alan Lundgard](https://www.alanlundgard.com/), is thinking a lot about the affordances of natural language and its ability to create clear, concise text summaries, and there have been projects like **(Slide 25)** "[Alt Text as Poetry](https://alt-text-as-poetry.net/)" that teaches people how to implement this in practice.
