...
[diagram that shows STS and disability studies together with an arrow towards the text "data visualization"](img/reimagining-access/1-zoom-access-ineq.png)
...
[tweet from Liz Jackson that says "The remnants of a Zoom bombing of a disability event" with a black square](img/reimagining-access/2-liz-jackson-bomb.png)
...
[a vinyl map of MIT where there are raised etchings for different components of the campus](img/reimagining-access/4-mit-tactual.png)
...
[page from a handbook that shows sketches of different tools made for embossing tactile graphics: scalpels, pen-like utensils to punch bumps in the paper](img/reimagining-access/5-tactile-tools.png)
...
[a close-up view of the tactual map of MIT, where you can see the individual dots and lines that make up a building](img/reimagining-access/6-mit-tactual-detail.png)
...
[image of a blue book with a spiral binding that says "Alt Text as Poetry"](img/reimagining-access/8-alt-text-poetry.png)
